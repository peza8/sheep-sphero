...
device.on('connect', () => {
  ...
  device.subscribe('development/makers/challenge/tokens');
  device.subscribe('development/makers/challenge/clues');
  device.subscribe('development/makers/challenge/answers');
  device.subscribe('development/makers/challenge/answers/errors');
  device.subscribe('development/makers/challenge/answers/accepted');
});
...
device.on('message', (topic, payload) => {
  ...
  switch (topic) {
    case 'development/makers/challenge/tokens':
